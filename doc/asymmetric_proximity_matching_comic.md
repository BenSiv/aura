# Ghost Mode: A Proximity Comic Script

This document contains the visual layout, illustration prompts, dialogue, and narrative captions for a 4-panel comic strip explaining how AuraRadar's **Ghost Mode (Asymmetric Matching)** keeps users safe in crowded spaces. 
...
|                                    |                                    |
|              PANEL 1               |              PANEL 2               |
|       The Crowded Commute          |         The Silent Shield          |
|                                    |                                    |
+------------------------------------+------------------------------------+
|                                    |                                    |
|              PANEL 3               |              PANEL 4               |
|           Safe & Sound             |       The Spontaneous Match        |
|                                    |                                    |
+------------------------------------+------------------------------------+
```
...
* **Sarah's Thought Bubble**: *(Looking worried)* "If I turn on standard location apps here, everyone in this bus will see exactly where I'm sitting... I don't want any unwanted cold approaches."
* **Alex's Screen**: Shows his active AuraRadar profile: *"Vibe tags: Rust Dev, Sci-Fi, Indie Music"*
* **Narrator Voiceover**: But Sarah has a secret weapon...
...
* **Visual**: Split screen. 
  ...
  * *Right side (Alex Walking Home)*: Alex is walking his dog under streetlights a mile away, completely unaware.
* **Caption**: Hours later, from the absolute safety of her private space...
* **Sarah**: "Perfect. Now that I'm home, let's send that swipe!"
* **Narrator Voiceover**: Since they are no longer in range, local short-range wireless is offline. Sarah's app automatically locks her profile inside an encrypted **digital envelope** that only Alex's phone can open, and sends it via secure email.
